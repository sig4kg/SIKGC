...
public class ResultSetStats {
	...
	public static void main(String[] args) {
		...
		ResultSet rs = new ResultSet("results", "exp/summer/analysis/YAGO/C3AC20995-all-10000-k10-ALL", true, 10);
		...
		System.out.println("Head: " + counterHeadLow + " | " + counterHeadMedium + " | " + counterHeadHigh + " | " + (counterHeadLow + counterHeadMedium + counterHeadHigh));
		System.out.println("Tail: " + counterTailLow + " | " + counterTailMedium + " | " + counterTailHigh + " | " + (counterHeadLow + counterHeadMedium + counterHeadHigh));
