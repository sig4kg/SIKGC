	...
	public static void main(String[] args) throws IOException {
		...
		if (target.equals("WD")) {
			...
			results = new ResultSet[]{
					...
					new ResultSet("500      ","exp/february/final/rg/wikidata-rt-c2a1g1-p1s1-predictionsZ-AVG-500", true, 10),
					new ResultSet("1000     ","exp/february/final/rg/wikidata-rt-c2a1g1-p1s1-predictionsZ-AVG-1000", true, 10),
					new ResultSet("5000     ","exp/february/final/rg/wikidata-rt-c2a1g1-p1s1-predictionsZ-AVG-5000", true, 10),
					new ResultSet("10000    ","exp/february/final/rg/wikidata-rt-c2a1g1-p1s1-predictionsZ-AVG-10000", true, 10),
		...
		if (target.equals("WN18")) {
			...
			results = new ResultSet[]{
					...
					new ResultSet("100    5    ", "exp/february/final/free/wn18-c5a1g1-p1s1-preds-100", true, 10),
					new ResultSet("500    5    ", "exp/february/final/free/wn18-c5a1g1-p1s1-preds-500", true, 10),
					new ResultSet("1000   5    ", "exp/february/final/free/wn18-c5a1g1-p1s1-preds-1000", true, 10),
					new ResultSet("5000   5    ", "exp/february/final/free/wn18-c5a1g1-p1s1-preds-5000", true, 10),
					new ResultSet("10000  5    ", "exp/february/final/free/wn18-c5a1g1-p1s1-preds-10000", true, 10),
		...
		if (target.equals("WN18RR")) {
			...
			results = new ResultSet[]{
					new ResultSet("100   5     ", "exp/february/final/free/wn18rr-c5a1g1-p1s1-preds-100", true, 10),
					new ResultSet("500   5     ", "exp/february/final/free/wn18rr-c5a1g1-p1s1-preds-500", true, 10),
					new ResultSet("1000  5     ", "exp/february/final/free/wn18rr-c5a1g1-p1s1-preds-1000", true, 10),
					new ResultSet("5000  5     ", "exp/february/final/free/wn18rr-c5a1g1-p1s1-preds-5000", true, 10),
					new ResultSet("10000 5     ", "exp/february/final/free/wn18rr-c5a1g1-p1s1-preds-10000", true, 10),
		...
		if (target.equals("YAGO")) {
			...
			results = new ResultSet[]{
					new ResultSet("p2s5   49", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-49", true, 10),
					new ResultSet("p2s5   51", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-51", true, 10),
					new ResultSet("p2s5   50", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-50", true, 10),
					null,
					new ResultSet("p2s5   99", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-99", true, 10),
					new ResultSet("p2s5  101", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-101", true, 10),
					new ResultSet("p2s5  100", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-100", true, 10),
					null,
					new ResultSet("p2s5  449", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-499", true, 10),
					new ResultSet("p2s5  501", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-501", true, 10),
					new ResultSet("p2s5  500", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-500", true, 10),
					null,
					new ResultSet("p2s5  999", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-999", true, 10),
					new ResultSet("p2s5 1001", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-1001", true, 10),
					new ResultSet("p2s5 1000", "exp/february/ext/yagoxxx-c3a1-p2s5-predictions-1000", true, 10),
					null,
		...
		if (target.equals("FB15-237")) {
			...
			results = new ResultSet[]{
					...
					new ResultSet("p2s5   49", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-49", true, 10),
					new ResultSet("p2s5   51", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-51", true, 10),
					new ResultSet("p2s5   50", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-50", true, 10),
					null,
					new ResultSet("p2s5   99", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-99", true, 10),
					new ResultSet("p2s5  101", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-101", true, 10),
					new ResultSet("p2s5  100", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-100", true, 10),
					null,
					new ResultSet("p2s5  449", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-499", true, 10),
					new ResultSet("p2s5  501", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-501", true, 10),
					new ResultSet("p2s5  500", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-500", true, 10),
					null,
					new ResultSet("p2s5  999", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-999", true, 10),
					new ResultSet("p2s5 1001", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-1001", true, 10),
					new ResultSet("p2s5 1000", "exp/february/ext/fb237xxx-c3a1-p2s5-predictions-1000", true, 10),
					null,
		...
		if (target.equals("FB15")) {
			...
			results = new ResultSet[]{
					...
					new ResultSet("p2s5   49", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-49", true, 10),
					new ResultSet("p2s5   51", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-51", true, 10),
					new ResultSet("p2s5   50", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-50", true, 10),
					new ResultSet("p2s5   49", "exp/february/ext/fb15yyy-c3a1-p2s5-predictions-49", true, 10),
					new ResultSet("p2s5   51", "exp/february/ext/fb15yyy-c3a1-p2s5-predictions-51", true, 10),
					new ResultSet("p2s5   50", "exp/february/ext/fb15yyy-c3a1-p2s5-predictions-50", true, 10),
					null,
					new ResultSet("p2s5   99", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-99", true, 10),
					new ResultSet("p2s5  101", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-101", true, 10),
					new ResultSet("p2s5  100", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-100", true, 10),
					new ResultSet("p2s5   99", "exp/february/ext/fb15yyy-c3a1-p2s5-predictions-99", true, 10),
					new ResultSet("p2s5  101", "exp/february/ext/fb15yyy-c3a1-p2s5-predictions-101", true, 10),
					new ResultSet("p2s5  100", "exp/february/ext/fb15yyy-c3a1-p2s5-predictions-100", true, 10),
					null,
					new ResultSet("p2s5  449", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-499", true, 10),
					new ResultSet("p2s5  501", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-501", true, 10),
					new ResultSet("p2s5  500", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-500", true, 10),
					null,
					new ResultSet("p2s5  999", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-999", true, 10),
					new ResultSet("p2s5 1001", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-1001", true, 10),
					new ResultSet("p2s5 1000", "exp/february/ext/fb15xxx-c3a1-p2s5-predictions-1000", true, 10),
					null,
		...
		for (ResultSet rs : results) {
			...
			if (rs == null) {
				...
				// System.out.println(rs.getName() + "   " + hitsAtK.getHitsAtKDouble(0) + "   " + hitsAtK.getHitsAtKDouble(9));
