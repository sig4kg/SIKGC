...
def cecmcrc(work_dir, input_dir, schema_file, tbox_patterns_dir, epoch=2, loops=1, use_gpu=False):
    ...
    for ep in trange(loops, colour="green", position=0, leave=True, desc="Pipeline processing"):
        init_c1, extend_c1, nc1, nv1, ncc1 = EC_block(context_resource, abox_scanner_scheduler, work_dir + "E/", epoch=epoch, use_gpu=use_gpu)
