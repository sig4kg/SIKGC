...
public class DiffRank1 {
	...
	public static void main(String[] args) {
		...
		ResultSet rs1            = new ResultSet("stable         ", "exp/september/local/fb237-predictions-500-stable", true, 10);
		ResultSet rs2            = new ResultSet("stable-x       ", "exp/september/local/fb237-predictions-500-stable-x", true, 10);
