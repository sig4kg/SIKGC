...
if __name__ == "__main__":
    ...
    context_res = ContextResources(triples_path, class_and_op_file_path= class_and_op_file_path, work_dir="../outputs/test_dbpedia/", create_id_file=True)
    ...
    abox_scanner_scheduler.scan_schema_correct_patterns(work_dir='../outputs/test_dbpedia/')
