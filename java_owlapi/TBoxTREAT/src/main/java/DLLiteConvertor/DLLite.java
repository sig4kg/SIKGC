...
//        iog1.fillOntology(man.getOWLDataFactory(), infOnt1);
        OWLOntology infOnt1 = koncludeClassifier(ont, man);
        // merge ont and infOnt1
        System.out.println("merging infOnt1 to ont...");
        OWLOntologyMerger merger = new OWLOntologyMerger(man);
        IRI mergedOntologyIRI1 = IRI.create("http://www.semanticweb.com/merged1");
        ...
        // replace neg A with expressions
//        System.out.println("Replace neg A with expressions...");
//        Set<OWLSubClassOfAxiom> subclassof0 = merged1.getAxioms(AxiomType.SUBCLASS_OF);
//        for (OWLSubClassOfAxiom s : subclassof0) {
//            OWLClassExpression sub = s.getSubClass();
//            OWLClassExpression sup = s.getSuperClass();
//            String subIRI = "";
//            String supIRI = "";
...
//        }
        // remove additional classes
//        System.out.println("Removing N_i...");
//        OWLEntityRemover remover0 = new OWLEntityRemover(merged1);
//        for (OWLClass namedClass : merged1.getClassesInSignature()) {
//            if (map.containsKey(namedClass.getIRI().toString())) {
//                namedClass.accept(remover0);
//            }
//        }
//        man.applyChanges(remover0.getChanges());
//        map.clear();
...
//        iog2.fillOntology(man.getOWLDataFactory(), infOnt2);
        OWLOntology infOnt2 = koncludeClassifier(merged1, man);
        // merged1 and infOnt2
...
//        iog3.fillOntology(man.getOWLDataFactory(), infOnt3);
        OWLOntology infOnt3 = koncludeClassifier(merged2, man);
        // merge new inferred atoms
